  ...
  return (
    <>
        ...
        >
            ...
            <div className="p-5 rounded-2xl bg-gradient-to-br from-blue-900 to-slate-900 text-white shadow-lg space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-center sm:text-left">
                ...
                <div className="sm:text-right">
                  <span className="text-[11px] text-amber-300 block font-bold">TOTAL EXACT VERROUILLÉ</span>
          ...
          <div className="p-4 sm:p-6 bg-slate-50 dark:bg-slate-950 border-t border-slate-200 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center space-x-2 px-5 py-3 rounded-xl bg-blue-900 hover:bg-blue-800 text-white font-bold text-xs shadow-md transition-all whitespace-nowrap"
            >
      ...
      <WavePaymentModal
        ...
        amount={totalPrice}
        serviceTitle={`Simulation ${selectedService.name} (${quantity} ${selectedService.unitLabel})`}
      />
    </>
  );
};
